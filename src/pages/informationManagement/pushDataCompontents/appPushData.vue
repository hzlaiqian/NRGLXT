      ...
      <el-col :span="6">
        <div class="cardLittle">
          ...
          <div class="cardLittleBottom">
            <div class="compare">环比昨日</div>
            <div class="num">
              <span v-if="topData.clickRt>=0">增长</span>
              <span v-else>减少</span>{{topData.clickRt}}%
              <img v-if="topData.clickRt>=0" src="../../../assets/img/up.png" alt="">
              <img v-else src="../../../assets/img/down.png" alt="">
            </div>
          </div>
          <div class="img">
      ...
      <el-col :span="6">
        <div class="cardLittle">
          ...
          <div class="cardLittleBottom">
            <div class="compare">环比昨日</div>
            <div class="num">
              <span v-if="topData.clickRateRt>=0">增长</span>
              <span v-else>减少</span>{{topData.clickRateRt}}%
              <img v-if="topData.clickRateRt>=0" src="../../../assets/img/up.png" alt="">
              <img v-else src="../../../assets/img/down.png" alt="">
            </div>
          </div>
          <div class="img">
  ...
  export default {
    ...
    data() {
      return {
        ...
        color:['#2A79EE','#FFB03A','#F74E4E','#78E1CD'],
      };
    },
    computed: {
    ...
    methods: {
      ...
      //获取头部卡片数据
      getAppPushTopData(){
        getAppPushTopData({channel:2}).then((res) =>{
      ...
      getHisNumAndClick(beginDate,endDate){
        ...
        getHisAndClick({channel:2,beginDate:beginDate,endDate:endDate}).then((res) =>{
      ...
      getHisUserNumAndUserClick(beginDate,endDate){
        ...
        getHisUserAndClick({channel:2,beginDate:beginDate,endDate:endDate}).then((res) =>{
      ...
      getHisHotClickAndPushClick(beginDate,endDate){
        ...
        getHotClickAndGu({channel:2,beginDate:beginDate,endDate:endDate}).then((res) => {
      ...
      getUserGroupClick(beginDate,endDate){
        ...
        getUserGroup({channel:2,beginDate:beginDate,endDate:endDate}).then((res) =>{
          if(res.data.name){
      ...
      //4
      userGroupClick(chartSet, data, date, userGroup) {
        chartSet.setOption(
          {
            grid: {
              top: '15%',
